<?php
	...
	*/
	...
	/**
	 * All Tier 4 Authentication Layer Test Cases
	 *
	 * This file is designed to run all test cases for Tier 4 Authentication Layer.
	 *
	 ...
	 * @version C++ - Unknown
 	*/
	class Tier4AuthenticationLayerAllTests extends TestSuite {
		 ...
		 * @access public
		*/	
		public function Tier4AuthenticationLayerAllTests() {
			$this->FILES = parse_ini_file(dirname(__FILE__) . '/Files.ini', true);
			
			$this->TestSuite('Tier 4 - Authentication Layer - All Tests');
			if ($this->FILES != NULL) {
