<?php
	...
	*/
	...
	require_once "$HOME/Testcases/Configuration/Tier4AuthenticationLayerSettings.php";

	// Tier 5 Validation Layer Settings
	require_once "$HOME/Testcases/Configuration/Tier5ValidationLayerSettings.php";
	...
	/**
	 * Tier 4 Creation Test
	 *
	 * This file is designed to create Tier 4.
	 *
	 ...
	 * @version C++ - Unknown
 	*/
	class Tier4CreationTest extends UnitTestCase {
		/**
		 * Tier3Database: AuthenticationLayer object for Tier 4
		 *
		 * @var object
		 */
		private $Tier4Authentication;
		 
		public function testTier4CreationTest () {
			$this->Tier4Authentication = new AuthenticationLayer();
			$this->assertNotNull($this->Tier4Authentication);
		}
	}
?>