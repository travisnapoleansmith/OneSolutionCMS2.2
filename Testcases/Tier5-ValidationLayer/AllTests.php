<?php
	...
	*/
	...
	/**
	 * All Tier 5 Validation Layer Test Cases
	 *
	 ...
	 * @version C++ - Unknown
 	*/
	class Tier5ValidationLayerAllTests extends TestSuite {
		 ...
		 * @access public
		*/	
		public function Tier5ValidationLayerAllTests() {
			$this->FILES = parse_ini_file(dirname(__FILE__) . '/Files.ini', true);
			
			$this->TestSuite('Tier 5 - Validation Layer - All Tests');
			if ($this->FILES != NULL) {
