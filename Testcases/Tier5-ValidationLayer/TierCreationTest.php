<?php
	...
	*/
	...
	/**
	 * Tier 5 Creation Test
	 *
	 * This file is designed to create Tier 5.
	 *
	 ...
	 * @version C++ - Unknown
 	*/
	class Tier5CreationTest extends UnitTestCase {
		/**
		 * Tier3Database: ValidationLayer object for Tier 5
		 *
		 * @var object
		 */
		private $Tier5Validation;
		 
		public function testTier5CreationTest () {
			$this->Tier5Validation = new ValidationLayer();
			$this->assertNotNull($this->Tier5Validation);
		}
	}
?>