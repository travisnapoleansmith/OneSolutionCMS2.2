<?php
	...
	*/
	...
	/**
	 * Tier 2 SOAP Create Database Table Test
	 *
	...
	class Tier2SetCreateDatabaseTableTest extends UnitTestCase {
		...
		/**
		 * Create an instance of Tier2SetCreateDatabaseTableTest.
		 *
		 * @access public
		*/	
